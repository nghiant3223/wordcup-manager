...
public class RoundUtilsTest {
    ...
    @Test
    public void test_getKnockoutRoundResult(){
        ...
        Map<Integer, Team[]> result = RoundUtils.getKnockoutRoundResult(matchList);
        Team[] matchKnockoutTeam =  result.get(0);
        Team[] matchKnockoutTeam2 =  result.get(1);
        Assert.assertEquals(2, result.size());
        Assert.assertEquals(TeamHome, matchKnockoutTeam[0]);
        Assert.assertEquals(TeamHome2, matchKnockoutTeam2[0]);
    }

    @Test
    public void test_getKnockoutRoundResult_match_empty(){
    ...
    @Test
    public void test_getFinalResult(){
        ...
        Map<Integer, Team[]> result = RoundUtils.getFinalResult(matchKnockout);

        Team[] finalWinner =  result.get(0);
        Assert.assertEquals(1, result.size());
        Assert.assertEquals(TeamHome, finalWinner[0]);
    }

    @Test(expected = Exception.class)
    public void test_getFinalResult_empty(){

        Match match = null;
        Map<Integer, Team[]> result = RoundUtils.getFinalResult(match);
